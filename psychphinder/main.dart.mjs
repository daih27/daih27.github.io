...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1284: (x0,x1) => x0.getAttribute(x1),
      _1288: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1298: x0 => x0.click(),
      _1299: x0 => x0.remove(),
      _1309: (x0,x1) => x0.getItem(x1),
      _1311: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1321: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1369: Object.is,
      _1370: o => o instanceof Array,
      _1371: (a, i) => a.push(i),
      _1374: (a, l) => a.length = l,
      _1375: a => a.pop(),
      _1376: (a, i) => a.splice(i, 1),
      _1377: (a, s) => a.join(s),
      _1378: (a, s, e) => a.slice(s, e),
      _1380: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1381: a => a.length,
      ...
      _1387: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1389: o => o instanceof Uint8Array,
      _1390: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Int8Array,
      _1392: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Uint8ClampedArray,
      _1394: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1395: o => o instanceof Uint16Array,
      _1396: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1397: o => o instanceof Int16Array,
      _1398: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1399: o => o instanceof Uint32Array,
      _1400: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1401: o => o instanceof Int32Array,
      _1402: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1404: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1405: o => o instanceof Float32Array,
      _1406: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1407: o => o instanceof Float64Array,
      _1408: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1409: (t, s) => t.set(s),
      _1410: l => new DataView(new ArrayBuffer(l)),
      _1411: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1413: o => o.buffer,
      _1414: o => o.byteOffset,
      _1415: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1416: (b, o) => new DataView(b, o),
      _1417: (b, o, l) => new DataView(b, o, l),
      _1418: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1419: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1420: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1421: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1422: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1423: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1424: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1425: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1426: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1427: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1428: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1429: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1432: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1433: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1434: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1435: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1436: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1437: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1450: (ms, c) =>
      ...
      _1517: x0 => x0.openCursor(),
      _1518: x0 => x0.continue(),
      ...
      _1753: (x0,x1) => { x0.draggable = x1 },
      _1769: x0 => x0.style,
      _1984: (x0,x1) => { x0.href = x1 },
      _2128: (x0,x1) => { x0.download = x1 },
      _2153: (x0,x1) => { x0.href = x1 },
      _2698: (x0,x1) => { x0.accept = x1 },
      _2712: x0 => x0.files,
      _2738: (x0,x1) => { x0.multiple = x1 },
      _2756: (x0,x1) => { x0.type = x1 },
      _3006: (x0,x1) => { x0.src = x1 },
      _3012: (x0,x1) => { x0.async = x1 },
      _3475: () => globalThis.window,
      _3514: x0 => x0.self,
      _3515: x0 => x0.document,
      _3518: x0 => x0.location,
      _3537: x0 => x0.navigator,
      _3794: x0 => x0.indexedDB,
      ...
      _6076: x0 => x0.signal,
      _6131: x0 => x0.baseURI,
      _6137: x0 => x0.firstChild,
      _6148: () => globalThis.document,
      _6230: x0 => x0.body,
      _6562: (x0,x1) => { x0.id = x1 },
      _6585: x0 => x0.innerHTML,
      _6586: (x0,x1) => { x0.innerHTML = x1 },
      _6589: x0 => x0.children,
      _7908: x0 => x0.value,
      _7910: x0 => x0.done,
      _8090: x0 => x0.size,
      _8091: x0 => x0.type,
      ...
      _8605: x0 => x0.url,
      _8607: x0 => x0.status,
      _8609: x0 => x0.statusText,
      _8610: x0 => x0.headers,
      _8611: x0 => x0.body,
      _10067: x0 => x0.result,
      _10068: x0 => x0.error,
      _10073: (x0,x1) => { x0.onsuccess = x1 },
      _10075: (x0,x1) => { x0.onerror = x1 },
      _10079: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10097: x0 => x0.version,
      _10098: x0 => x0.objectStoreNames,
      _10165: x0 => x0.key,
      _10168: x0 => x0.value,
      _11006: (x0,x1) => { x0.display = x1 },
      _12228: x0 => x0.name,
